...
function createSignUpEmbedWithButton() {
    const embed = new EmbedBuilder()
        ...
        .setImage("https://cdn.discordapp.com/banners/927284201529704470/6b6ca199eed4b70d382492adbf536c96.png?size=480");

    const button = new ButtonBuilder()
        .setURL('https://bataillon-sacre-inscription.vercel.app')
